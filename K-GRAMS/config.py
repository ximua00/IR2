...
config.add_argument('-exp_name', '--exp_name', required=False, type=str, default ="han_test", help='Experiment Name')
...
config.add_argument('-batch_size', '--batch_size', required=False, type=int, default=16, help='Batch size')
...
config.add_argument('-epochs', '--epochs', required=False, type=int, default=21, help='epochs')
...
config.add_argument('-save_freq', '--save_freq', required=False, type=int, default=5, help='Model save Frequency')
