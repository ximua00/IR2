...
tf.flags.DEFINE_string("word2vec", "/content/NARRE/data/google.bin", "Word2vec file with pre-trained embeddings (default: None)")
...
if __name__ == '__main__':
    ...
    # Displaying the values of the flag attributes
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            for epoch in range(40):
                ...
                if best_rmse > rmse:
                    best_rmse = rmse
                    saver.save(sess, '/content/drive/My Drive/best_model')
                if best_mae > mae: 
                    best_mae = mae 
                print("")
